# # -*- coding: utf-8 -*-
# """
# Created on Sat Jun 20 12:18:13 2020

# @author: Atul Manmohan
...
for epochs in range(1, nb_epochs+1):
    ...
    for id_user in range(0, no_users-batch_size, batch_size):
        ...
        #print('shape is', ph0.shape, phk.shape, (torch.mm(v0.t(), ph0) - torch.mm(vk.t(), phk)).shape)
        rbm.train(v0, vk, ph0, phk)
        train_loss += torch.mean(torch.abs(v0[v0>=0]-vk[v0>=0]))
        S +=1.0
    print('Epochs: '+ str(epochs)+ ' loss: ' + str(train_loss/S))
